  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      {books.map((item) => (
        <div
          key={item.id}
          className="bg-white border border-blue-100 rounded-xl shadow-sm hover:shadow-md cursor-pointer flex flex-col items-center p-3 transition-transform hover:scale-105"
        ...
        >
          ...
          <h3 className="font-medium text-center text-xs mb-1 line-clamp-2 text-blue-900">{item.titulo}</h3>
